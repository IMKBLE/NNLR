function [TrainingTime, TestingTime, TrainingAccuracy, TestingAccuracy,TY,Y] =LRR_ELM(TrainingData_File, TestingData_File, Elm_Type, NumberofHiddenNeurons, ActivationFunction,lamda)
