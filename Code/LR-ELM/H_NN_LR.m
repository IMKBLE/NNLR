function [TrainingTime, TestingTime, TrainingAccuracy, TestingAccuracy,TY,Y] =H_NN_LR(TrainingData_File, TestingData_File, Elm_Type, NumberofHiddenNeurons, ActivationFunction,lamda)
