function [ TrainingAccuracy, TestingAccuracy,TY,Y] = L21_LR(TrainingData_File, TestingData_File, Elm_Type,lamda)
...
lambda = lamda(1,1);
miu = lamda(1,2);
[OutputWeight, AStar] = get_L21_elm_solve(H',T',lambda,miu);
%%
