...
function [test_result,train_result] =LR(TrainingData_File, TestingData_File)
...
train_data=TrainingData_File(:,2:size(TrainingData_File,2))';             
...
w = pinv(train_data*train_data')*train_data*Y';
save('../LR_coefficient_matrix.mat','w');
