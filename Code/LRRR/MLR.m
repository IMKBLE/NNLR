function acc = MLR(train_data,train_label,test_data,test_label,lamda,s,multi_view_predict,num_HN)
...
input_weigth_base = rand(5000,5000)*2-1;  %随机生成网络结构
bias_HN_base = rand(5000,1);
...
acc = (sum(test_label==y)/num_test)*100;
